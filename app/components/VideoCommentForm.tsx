...
import { VideoCommentSchema, type VideoCommentResponse } from "~/schemas/videoComment";
import { z } from "zod";

export const VideoCommentForm = ({ videoId }: { videoId: string }) => {
  const fetcher = useFetcher<VideoCommentResponse>();
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      fetcher.submit(
        ...
        {
          method: "POST",
          action: `/api/videos/${videoId}/comments`,
        }
      );
