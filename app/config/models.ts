...
export const MODEL_OPTIONS = [
  {
    ...
    description: "Flagship 8B parameter model with exceptional quality and prompt adherence.",
  ...
  },
  {
    ...
    image: "/assets/model-thumbs/sdxlv1.jpg",
    description: "Fast 4-step generation while maintaining high quality.",
    company: "Stability AI",
    supportsStyles: false,
    creditCost: 2,
    recommended: true,
  },
  {
    ...
    description: "Balanced 2.5B parameter model for fast and efficient performance.",
    company: "Stability AI",
    supportsStyles: false,
    creditCost: 2,
    recommended: true,
  },
  {
    ...
    description: "Cost-effective model with good quality for everyday use.",
    company: "Stability AI",
    supportsStyles: false,
    creditCost: 1,
    recommended: true,
  },
  {
    ...
    image: "/assets/model-thumbs/sdxlv1.jpg",
    description: "Premium model with exceptional detail, color, and lighting.",
    company: "Stability AI",
    supportsStyles: false,
    creditCost: 6,
    recommended: false,
